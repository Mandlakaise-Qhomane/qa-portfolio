...
public final class DriverFactory {
    ...
    private static WebDriver localChrome() {
        ...
        options.addArguments("--window-size=412,915", "--no-sandbox", "--disable-dev-shm-usage");
    ...
    private static WebDriver androidDriver() {
        ...
        try {
            ...
            throw new IllegalStateException("Could not start AndroidDriver. Is Appium on 4723 and an emulator running?", e);
        }
    }
