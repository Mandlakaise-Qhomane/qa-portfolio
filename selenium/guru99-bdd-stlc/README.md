...
**SUT:** Local bank fixture that mirrors Guru99 Bank V4 field names (started automatically on `http://127.0.0.1:18080/`).  
**Why local:** the public Guru99 demo expires manager IDs and is not recruiter-safe.  
...
**Cases:** 10 Gherkin scenarios — expected result **10 PASS**

The live demo is documented only. `mvn test` never depends on it.
